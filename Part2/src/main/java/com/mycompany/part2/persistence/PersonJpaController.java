...
public class PersonJpaController implements Serializable {
    ...
    public List<Person> findPeopleEntities() {
        return findPeopleEntities(true, -1, -1);
    }

    public List<Person> findPeopleEntities(int maxResults, int firstResult) {
        return findPeopleEntities(false, maxResults, firstResult);
    }

    private List<Person> findPeopleEntities(boolean all, int maxResults, int firstResult) {
